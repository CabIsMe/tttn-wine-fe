...
export default function Page(
    ...
    const renderInventory_number = () => {
        const result = [];
        if (productDetail.inventory_number > 10){
            productDetail.inventory_number = 10
        }
        for (let index = 1; index <= productDetail.inventory_number; index++) {
                ...
                <section className="text-gray-700 body-font overflow-hidden ">
                    ...
                    <div className="container px-5 py-24 mx-auto">
                        ...
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <h2 className="text-sm title-font text-gray-500 underline tracking-widest">{productDetail.category_info.category_name}</h2>
